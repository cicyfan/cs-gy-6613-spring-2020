...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cs-gy-6613-spring-2020/flexsearch.min.js');loadScript('/cs-gy-6613-spring-2020/en.search-data.min.faee87c6315cf986590853579456c710874510a646ea1d536814f1e77b93f40a.js',function(){input.required=false;search();});}
