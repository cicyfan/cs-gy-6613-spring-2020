...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cs-gy-6613-spring-2020/flexsearch.min.js');loadScript('/cs-gy-6613-spring-2020/en.search-data.min.48be36fed14e91b71a6c2bf41985c91f5a4dc04a415c2903c18cd2ae6badd742.js',function(){input.required=false;search();});}
