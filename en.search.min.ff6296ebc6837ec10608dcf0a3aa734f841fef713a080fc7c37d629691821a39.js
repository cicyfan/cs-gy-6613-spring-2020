...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cs-gy-6613-spring-2020/flexsearch.min.js');loadScript('/cs-gy-6613-spring-2020/en.search-data.min.830678140463daf8ac38ef5973b4804686db94f3d5ec5d6c1527a17cbc9b721a.js',function(){input.required=false;search();});}
