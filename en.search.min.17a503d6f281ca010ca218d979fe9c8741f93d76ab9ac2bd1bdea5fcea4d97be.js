...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cs-gy-6613-spring-2020/flexsearch.min.js');loadScript('/cs-gy-6613-spring-2020/en.search-data.min.1b4a1e2aef4e8a187c22a5bba6154ce7bca10d01f651917e4eada6ab89b618db.js',function(){input.required=false;search();});}
