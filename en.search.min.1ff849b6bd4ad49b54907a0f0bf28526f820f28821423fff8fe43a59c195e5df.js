...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cs-gy-6613-spring-2020/flexsearch.min.js');loadScript('/cs-gy-6613-spring-2020/en.search-data.min.6294065d145f259ec33f1a635fc452d5ee222ccce42f579ac6e3befaba9279d4.js',function(){input.required=false;search();});}
